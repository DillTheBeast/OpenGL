//g++ -I/Users/dillonmaltese/Documents/GitHub/OpenGL/include tut/square.cpp /Users/dillonmaltese/Documents/GitHub/OpenGL/src/glad.c -o main -L/Users/dillonmaltese/Documents/GitHub/OpenGL/lib -lglfw3 -framework OpenGL -framework Cocoa -framework IOKit -framework CoreVideo
#include <iostream>
#include <glad/glad.h>
...
int main() {
    ...
    // Making indices (Tells opengl where to draw each triangle)
    GLuint indices[] = {
        0, 1, 2, // Upper left triangle
        3, 2, 0, // Lower right triangle
    };
    ...
    // Generating everything with only 1 object each 
